...
//			System.exit(0);
		...
		Viewer viewerO = new Viewer("Original", p);
...
//		viewer.show();
	...
	private static String[] filterNames = new String[FilterLib.class.getDeclaredFields().length];
	...
	private int selectFilter() {
		...
		return filterSelector.getSelectedIndex();
	}
